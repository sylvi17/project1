          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                ...
                <div class="overflow-y-auto py-4 px-3">
                  <ul class="space-y-2">
                    <x-admin.sidelink name="Students" link="/admin/students" />
                    <x-admin.sidelink name="Classrooms" link="/admin/classrooms" />
                    <x-admin.sidelink name="Teachers" link="/admin/teachers" />
                    <x-admin.sidelink name="Subjects" link="/admin/subjects" />
                    <x-admin.sidelink name="Guardians" link="/admin/guardians" />
                  </ul>
                </div>
