{{-- Modal Show Teacher --}}
<div id="showTeacherModal-{{ $teacher->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-center p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="showTeacherModal">
                    ✕
                </button>
            </div>
            ...
            <div class="p-4 space-y-4">
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $teacher->subject->availSubject }}" disabled
                            class="bg-gray-100 border border-gray-300 rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:text-white">
                    </div>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Numberr</label>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea disabled rows="4"
                            class="block w-full p-2.5 text-sm bg-gray-100 border border-gray-300 rounded-lg dark:bg-gray-600 dark:text-white">{{ $teacher->address }}</textarea>
                    </div>
                </div>
            </div>
